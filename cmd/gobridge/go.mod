...
require (
	...
	github.com/mariotoffia/gobridge/adapters/native/config/file v0.3.6
	github.com/mariotoffia/gobridge/adapters/native/credentials/file v0.3.6
	github.com/mariotoffia/gobridge/adapters/native/store v0.3.6
	github.com/mariotoffia/gobridge/httpapi v0.3.6
)
