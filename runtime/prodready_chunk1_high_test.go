...
// ════════════════════════════════════════════════════════════════════════════
// Chunk-1 HIGH-2 & HIGH-4 — DeepHealth route-readiness aggregation and the
...
// TestHigh2_RouteReadinessFoldsIntoReadyForTraffic proves DeepHealth's
...
func TestHigh2_RouteReadinessFoldsIntoReadyForTraffic(t *testing.T) {
...
// TestHigh4_SessionProbesRunConcurrentlyUnderOneDeadline proves the DeepHealth
...
func TestHigh4_SessionProbesRunConcurrentlyUnderOneDeadline(t *testing.T) {
