...
// ════════════════════════════════════════════════════════════════════════════
// Chunk-1 HIGH-1 — shared-outbox zero-plan fail-closed guard (resolvePlans).
//
...
// TestHigh1_SharedOutboxZeroPlans_NotAckedRoutedToPoison proves the shared-outbox
...
func TestHigh1_SharedOutboxZeroPlans_NotAckedRoutedToPoison(t *testing.T) {
