...
// TestValidator_PipelineTimeAutoExtend_NotRejected proves bound applies
...
// TestValidator_NegativeBackoffMaxInterval_Rejected is the startup regression:
...
// TestValidator_PipelineTime_DLQBudgetExcludedForDropPolicy proves DLQ
...
// against the conditional silently disabling the budget where it applies.
