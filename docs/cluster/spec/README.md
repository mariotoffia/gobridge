...
| **RFC 8342 (NMDA)** | *Intended* vs *operational* datastore — accepted ≠ applied; convergence is measured by diffing them. | The MQTT-R1 convergence check that a member must pass before it records `Converge`. |
