...
// ═══════════════════════════════════════════════════════════════════════════
// JSON Transform Middleware Unit Tests
//
// Tests for the JSON transform middleware covering:
// - Simple field mappings
// - Nested field extraction and creation
...
func TestJSONTransform_SimpleMapping(t *testing.T) {
	...
	msg := &types.Message{Payload: inputBytes}

	err = transform.Process(context.Background(), msg, func(ctx context.Context, m *types.Message) error {
		return nil
	})
	if err != nil {
