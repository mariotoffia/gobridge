...
// TestVerifyCandidateDigest_MatchAndTamper validates that a node verifies the
...
// TestNodeRolloutGate_F7ReadoptAfterCrashBeforeSwap validates that a node that
...
// TestEvaluateProposal_NackOnDigestMismatch validates that mismatched bytes are
