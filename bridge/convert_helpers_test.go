...
// and toDrainStrategy were removed from production convert.go: they had no
// non-test callers and hid conversion errors. They live here as test-only
// helpers so existing table-driven tests that feed known-good inputs stay
// concise; tests exercising the error paths call the *E variants directly.
