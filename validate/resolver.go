...
// Destination-resolver rules. A resolver picks the binding a message is sent to,
// so an unresolvable or unbound rule is a routing black hole rather than a
// cosmetic defect, and it must fail before commit.
