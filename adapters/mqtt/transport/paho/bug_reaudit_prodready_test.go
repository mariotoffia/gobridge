...
// --- M-1: sender.timeout is honoured when stricter than the caller deadline ---
...
// --- M-2: ingress user-property filter relaxed to UTF-8 + drops are metered ---
...
// rather than silent (M-2). A valid property alongside them still passes.
...
// --- M-3: client_id_suffix uniquification ---
...
// requires a stable SHARED client_id across instances (H-1).
...
// --- L-3: TLS floor is explicit ---

// TestBuildTLSConfig_SetsMinVersion proves BuildTLSConfig pins an explicit
// TLS 1.2 floor and passes InsecureSkipVerify through unchanged (L-3).
