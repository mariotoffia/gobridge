// ═══════════════════════════════════════════════
// Production-readiness remediation tests: session lifecycle.
//
//   - a failed INITIAL reconcile (Start with an installed plan) must
...
//     evidence.
//   - a failed reconcile during RECONNECT must not flip the session
...
//   - Start/Close and doReconnect/Close races must not install a
...
// TestSession_StartCloseRace_ClosesDialedConnection pins (Start/Close):
...
// TestSession_ReconnectCloseRace_ClosesDialedConnection pins
...
// TestSession_Health_ActiveTopics pins (code half): Health must expose
