...
// abandoned-publish budget (Chunk-11 HIGH-3 and HIGH-4).
//
// HIGH-3: the SDK's PublishWithDeferredConfirmWithContext IGNORES ctx and
...
//
// HIGH-4: an abandoned publish's reaper stays parked until the wedged publish
...
// is the HIGH-3 mutation catcher for the pipelined batch loop. A batch whose
