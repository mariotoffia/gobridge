...
// TestPollBackoffNextInitialS10 verifies the first next() delay is within
// [0.75s, 1.25s] for the 1s initial base.
...
// TestPollBackoffResetS10 verifies reset restores the backoff so the next
// next() is again near the 1s initial scale.
