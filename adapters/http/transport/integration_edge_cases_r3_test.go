...
// ---------------------------------------------------------------------------
// C1. TestEdgeR3_DuplicateReceiverID_ReturnsError
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// C1b. TestEdgeR3_DuplicateSenderID_ReturnsError
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// C2. TestEdgeR3_InvalidExpiresAtReturns400
// ---------------------------------------------------------------------------

func TestEdgeR3_InvalidExpiresAtReturns400(t *testing.T) {
	cases := []struct {
		name      string
		expiresAt string
	}{
...
// ---------------------------------------------------------------------------
// C2b. TestEdgeR3_ValidExpiresAtAccepted
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// C3. TestEdgeR3_SSEHeartbeatDelivered
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// C4. TestEdgeR3_ConcurrentPOSTProcessing
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// C6. TestEdgeR3_CustomPathPrefix
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// C9. TestEdgeR3_ForwarderContextCancelled
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// C11. TestEdgeR3_RemoteRouteNoForwarderReturns502
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// C12. TestEdgeR3_SSEResponseHeaders
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// C13. TestEdgeR3_SSESendContextCancelled
// ---------------------------------------------------------------------------
