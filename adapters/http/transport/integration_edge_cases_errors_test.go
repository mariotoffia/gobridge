...
// ---------------------------------------------------------------------------
// 1. TestEdge_EmitReturnsError
// ---------------------------------------------------------------------------

func TestEdge_EmitReturnsError(t *testing.T) {
...
// ---------------------------------------------------------------------------
// 2. TestEdge_RequestTimeout504
// ---------------------------------------------------------------------------

func TestEdge_RequestTimeout504(t *testing.T) {
	factory := transport.NewFactory()
...
// ---------------------------------------------------------------------------
// 3. TestEdge_SSEAuthRequired
// ---------------------------------------------------------------------------

func TestEdge_SSEAuthRequired(t *testing.T) {
	factory := transport.NewFactory()
...
// ---------------------------------------------------------------------------
// 4. TestEdge_SSEMaxClients
// ---------------------------------------------------------------------------

func TestEdge_SSEMaxClients(t *testing.T) {
	factory := transport.NewFactory()
...
// ---------------------------------------------------------------------------
// 5. TestEdge_ForwarderClusterKey
// ---------------------------------------------------------------------------

func TestEdge_ForwarderClusterKey(t *testing.T) {
...
// ---------------------------------------------------------------------------
// 6. TestEdge_UnsupportedSenderMode
// ---------------------------------------------------------------------------

func TestEdge_UnsupportedSenderMode(t *testing.T) {
	factory := transport.NewFactory()
	_, err := factory.NewSender(context.Background(), ports.SenderSpec{
		ID:     "ws-sender-r2",
...
// ---------------------------------------------------------------------------
// 7. TestEdge_CaseInsensitiveHeaderStripping
// ---------------------------------------------------------------------------

func TestEdge_CaseInsensitiveHeaderStripping(t *testing.T) {
	factory := transport.NewFactory()
...
// ---------------------------------------------------------------------------
// 8. TestEdge_SSENoConnectionHeader
// ---------------------------------------------------------------------------

func TestEdge_SSENoConnectionHeader(t *testing.T) {
	factory := transport.NewFactory()
	_, err := factory.NewSender(context.Background(), ports.SenderSpec{
		ID:     "sse-conn-r2",
