...
require (
	...
	github.com/mariotoffia/gobridge/adapters/aws/store/dynamodbdlq v0.5.0
	github.com/mariotoffia/gobridge/adapters/aws/store/dynamodblease v0.5.0
	github.com/mariotoffia/gobridge/adapters/aws/store/dynamodbmanagedsubscriptions v0.5.0
	github.com/mariotoffia/gobridge/adapters/aws/store/dynamodboutbox v0.5.0
