...
// visibility_timeout is bounded by the SQS broker limit (0..12h).
...
// skip the SendTimeout-vs-window check for auto-renewed windows.
func TestConfig_AutoExtendEnabled(t *testing.T) {
	...
	// for a window the runtime refuses to renew (a boundary regression).
