...
//
//   - HIGH-1: SendMessageBatch per-entry failures must classify the AWS
...
//   - HIGH-2: a malformed ("poison") message must not hot-loop forever. The
...
// ═══════════════════════════════════════════════════════════════════════════
// HIGH-1 — batch per-entry AWS error-code classification
// ═══════════════════════════════════════════════════════════════════════════

// TestClassifyBatchEntryCode_Chunk13 locks the per-entry Code → BridgeError
...
func TestClassifyBatchEntryCode_Chunk13(t *testing.T) {
	t.Parallel()
...
// TestSendBatch_Chunk13_RetryableCodesStayRetryable is the end-to-end
...
func TestSendBatch_Chunk13_RetryableCodesStayRetryable(t *testing.T) {
	t.Parallel()
...
// TestSendBatch_Chunk13_UnknownCodeFallsBackToSenderFault guards the fallback:
...
func TestSendBatch_Chunk13_UnknownCodeFallsBackToSenderFault(t *testing.T) {
	t.Parallel()
...
// ═══════════════════════════════════════════════════════════════════════════
// HIGH-2 — poison backstop + startup redrive-policy validation
// ═══════════════════════════════════════════════════════════════════════════
...
// TestPollAndConvert_Chunk13_PoisonBackstopDeletesAtThreshold verifies the
...
func TestPollAndConvert_Chunk13_PoisonBackstopDeletesAtThreshold(t *testing.T) {
	t.Parallel()
...
// TestPollAndConvert_Chunk13_PoisonBackstopBelowThresholdNoDelete verifies the
// backstop does NOT fire before the bound: the message is dropped WITHOUT a
// delete so a native redrive policy still owns it.
func TestPollAndConvert_Chunk13_PoisonBackstopBelowThresholdNoDelete(t *testing.T) {
	t.Parallel()
...
// TestPollAndConvert_Chunk13_PoisonBackstopDisabledNoDelete verifies the
...
func TestPollAndConvert_Chunk13_PoisonBackstopDisabledNoDelete(t *testing.T) {
	t.Parallel()
...
// TestCheckRedrivePolicy_Chunk13 exercises the startup redrive-policy check
...
func TestCheckRedrivePolicy_Chunk13(t *testing.T) {
	t.Parallel()
...
// TestCheckRedrivePolicy_Chunk13_PoisonVsNativeRedrive is the destructive-
...
// failure.
func TestCheckRedrivePolicy_Chunk13_PoisonVsNativeRedrive(t *testing.T) {
	t.Parallel()
...
// TestCheckRedrivePolicy_Chunk13_UnreadableStaysBestEffort proves the
...
func TestCheckRedrivePolicy_Chunk13_UnreadableStaysBestEffort(t *testing.T) {
	t.Parallel()
...
// TestConfigValidate_Chunk13_PoisonMaxReceives locks the static config-surface
...
// constructor path.
func TestConfigValidate_Chunk13_PoisonMaxReceives(t *testing.T) {
	t.Parallel()
