...
| **DurableSessionIdentity** | Opaque, secret-safe SHA-256 fingerprint returned by an optional typed plugin-config capability. Covers every effective field selecting transport-owned durable broker state; compared by the Supervisor before live reload and never logged as raw identity material. |
