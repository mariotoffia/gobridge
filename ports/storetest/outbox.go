...
func RunOutboxStoreTests(t *testing.T, store ports.OutboxStore) {
	...
	t.Run("ClaimRejectsZeroToken", func(t *testing.T) { testClaimRejectsZeroToken(t, store) })
	t.Run("CompleteRejectsZeroToken", func(t *testing.T) { testCompleteRejectsZeroToken(t, store) })
