...
// deferred-cleanup error path for L10.
...
// TestReservedTenantHeader_IsStrippedAtIngress proves the L6 root cause: the
...
// TestProcess_DecrementError_EmitsMetricAndLog is the L10 regression for the
...
// TestProcess_MessageCountError_EmitsMetricButSucceeds is the L10 regression for
...
// TestProcess_InFlightIncrementError_ClassifiedTransient is the L10 regression
...
// TestProcess_Reject_EmitsMetric is the L10 regression for tenant rejects: a
