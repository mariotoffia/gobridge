...
| T13 | Singleton constraint: synth-time scope scan that errors if multiple `GoBridgeSingle`/`GoBridgeCluster` exist in the same Stack tree. Lives in T10 or shared helper. — DONE | T11, T12 |
