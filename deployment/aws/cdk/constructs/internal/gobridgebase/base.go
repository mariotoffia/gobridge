...
const defaultBinaryPath = "/usr/local/bin/gobridge-aws"
...
type Props struct {
	...
	// base serializes it as the GOBRIDGE_AWS_BOOTSTRAP_JSON
...
func New(scope constructs.Construct, id *string, props *Props) *Built {
	...
	mainOpts := &awsecs.ContainerDefinitionOptions{
		...
		Environment: &map[string]*string{
			"GOBRIDGE_AWS_BOOTSTRAP_JSON": jsii.String(string(bootstrapJSON)),
