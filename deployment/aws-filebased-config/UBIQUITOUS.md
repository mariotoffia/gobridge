...
| **Profile base set** | Plugin families always linked into the profile binary, whatever build tags it carries: AWS (SQS, DynamoDB), MQTT, native stores and HTTP. AMQP 0-9-1, AMQP 1.0 and Azure Service Bus are optional families, linked by their `gobridge_<family>` tags. |
