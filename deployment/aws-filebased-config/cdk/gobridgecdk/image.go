...
// Naming and contract: deployment/aws-filebased-config/UBIQUITOUS.md.
type BridgeImageSource = imgsource.Source

// ImageGoBuildProps configures a build from a published, compatible lib module,
// without a repository checkout. See deployment/aws-filebased-config/UBIQUITOUS.md.
...
// Naming and contract: deployment/aws-filebased-config/UBIQUITOUS.md and PLUGIN.md.
