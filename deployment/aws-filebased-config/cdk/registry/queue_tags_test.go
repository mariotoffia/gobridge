...
func TestQueueTagsRegistryResolution(t *testing.T) {
	for _, tt := range []struct {
		...
		{"missing", sqs.Config{QueueTags: map[string]string{"app": "missing"}}, false, "BindQueueTags"},
		{"ambiguous", sqs.Config{QueueTags: map[string]string{"app": "bridge"}}, true, "ambiguous"},
		{"prefix excludes", sqs.Config{QueueTags: map[string]string{"app": "bridge"}, QueueNamePrefix: "other"}, false, "BindQueueTags"},
	} {
